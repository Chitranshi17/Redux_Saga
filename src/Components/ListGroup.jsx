...
import { deleteTodoRequest, editTodoRequest, editTodoSuccess, fetchTodoRequest, fetchTodoSuccess } from "../ReduxSaga/Todo/todoAction";
...
const mapDispatchToProper = (dispatch) => ({
  ...
  editData : (todo) => dispatch(editTodoRequest(todo))
});
